...
const FacebookLink = ({ handle }) => {
    return (
        <a href={`http://facebook.com/${handle}`}>
            <svg
                width="16"
                height="16"
                fill="currentColor"
...
const ThreadsLink = ({ handle }) => {
    return (
        <a href={`http://threads.net/${handle}`}>
            <svg
                width="16"
                height="16"
                fill="currentColor"
