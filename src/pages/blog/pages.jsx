...
const BLOG_PAGES = [
    ...
    },
    {
        ...
        content: (
            <>
                I’m Subsourian, admin of the Starcraft Wiki, and I wrote and
                helped direct Delta’s lines for Resurgence of the Storm.
                <br />
                <br />
                Delta Emblock is a more obscure character, hailing from the
                Ghost Academy manga as one of the psionic trainees that trained
                ...
                for is someone who’d be bubbly and personable off-duty but when
                she’s on the clock, she’d slit your neck without a second
                thought if she was ordered to.
                <br />
                <br />
                And I know some people were asking, “Why do a Ghost and not
                Tosh?,” but this is a case where a kit would not have matched
                Tosh’s character. He’s more of a psionic powerhouse, using
                terrazine to augment his powers. Whereas with Delta, we really
                wanted to dive into the Dominion Special Forces fantasy where
                you have the best of the best—Dominion’s tech being brought
                against your enemies.
                <br />
                <br />
                Delta’s a friendly and personable gal if she’s on your team, but
    ...
    },
    {
        ...
        title: "The Sound Design of Delta Emblock, An Original Character from Resurgence of the Storm",
        ...
        content: (
            <>
                ...
                <br />
                <br />
                She also has a weapon-swapping mechanic built into her kit,
                which is kind of what she's based around as a character in-game.
                This made her palette a lot more interesting and honestly a
                ...
                their shot, impact, and swap sounds, so her rifle is booming and
                ...
                hissing kind of weapon. It's not all junky, but it makes a lot
                of noise. It's not exactly quiet equipment. Her Q ability, which
                is her long shot for lack of a better phrase, changes. The sound
                changes depending on which weapon she currently has in play, so
                taking into account those core characteristics of each of the
                three weapons above, her Q ability will change depending on what
                ...
                was made by swinging a plastic PVC pipe and adding a lot of
                heavy flanging effects and ring modulation to create a fast
                fading shimmering effect, almost like a ghost. Her first
                ultimate was made using various clinking and clanging sounds. I
                was inspired by the LEGO building sound from the LEGO games.
                Some were foley, some were sourced, some were synthesized, to
                create that rapid building up and then breaking down effect of
                ...
                another level, and I was given a lot of parameters to work in,
                specifically references to previous StarCraft properties and
                other kinds of references to keep her unique and distinct, but
                also in line with what they imagined her to be.
                <br />
                <br />
                So making her was a fun and interesting challenge, and I love
                that I got the opportunity to do it.
            </>
        ),
    },
];
